...
var getStreamTypeFromAttr = (streamTypeAttr) => {
  if (!streamTypeAttr)
    return void 0;
  if ([StreamTypes2.LIVE, StreamTypes2.ON_DEMAND].includes(streamTypeAttr))
    return streamTypeAttr;
  if (streamTypeAttr == null ? void 0 : streamTypeAttr.includes("live"))
    return StreamTypes2.LIVE;
  return void 0;
};
...
var content = (props) => {
  ...
  <media-theme
    ...
    noautoseektolive="${!!((_c = props.streamType) == null ? void 0 : _c.includes(StreamTypes22.LIVE)) && props.targetLiveWindow !== 0}"
...
// src/index.tsx
var MuxPlayerInternal = React.forwardRef(({ children, ...props }, ref) => {
...
var MuxPlayer = React.forwardRef((props, ref) => {
...
//# sourceMappingURL=-UMUU4LIS.mjs.map
